...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UIDStatus.date'
        db.add_column('main_uidstatus', 'date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UIDStatus.date'
        db.delete_column('main_uidstatus', 'date')
    ...
    models = {
        ...
        'main.project': {
            ...
            'hierarchy': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'project'", 'unique': 'True', 'null': 'True', 'to': "orm['main.Role']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
