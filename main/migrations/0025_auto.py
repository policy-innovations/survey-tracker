...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field tags on 'Questionnaire'
        db.create_table('main_questionnaire_tags', (
        ...
        db.create_unique('main_questionnaire_tags', ['questionnaire_id', 'tag_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field tags on 'Questionnaire'
        db.delete_table('main_questionnaire_tags')
