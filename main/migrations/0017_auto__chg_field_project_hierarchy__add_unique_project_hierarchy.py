...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.hierarchy'
        db.alter_column('main_project', 'hierarchy_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['main.Role'], unique=True, null=True))

        # Adding unique constraint on 'Project', fields ['hierarchy']
        db.create_unique('main_project', ['hierarchy_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Project', fields ['hierarchy']
        db.delete_unique('main_project', ['hierarchy_id'])

        # Changing field 'Project.hierarchy'
        db.alter_column('main_project', 'hierarchy_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Role'], null=True))
    ...
    models = {
        ...
        'main.project': {
            ...
            'hierarchy': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['main.Role']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
