...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Choice'
        db.create_table('main_choice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Question'])),
        ))
        db.send_create_signal('main', ['Choice'])

        # Deleting field 'Question.lft'
        db.delete_column('main_question', 'lft')

        # Deleting field 'Question.parent'
        db.delete_column('main_question', 'parent_id')

        # Deleting field 'Question.level'
        db.delete_column('main_question', 'level')

        # Deleting field 'Question.tree_id'
        db.delete_column('main_question', 'tree_id')

        # Deleting field 'Question.rght'
        db.delete_column('main_question', 'rght')
        ...
        # Adding field 'UIDQuestion.selected_choice'
        db.add_column('main_uidquestion', 'selected_choice', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['main.Choice']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Choice'
        db.delete_table('main_choice')

        # Adding field 'Question.lft'
        db.add_column('main_question', 'lft', self.gf('django.db.models.fields.PositiveIntegerField')(default='', db_index=True), keep_default=False)

        # Adding field 'Question.parent'
        db.add_column('main_question', 'parent', self.gf('mptt.fields.TreeForeignKey')(related_name='subquestions', null=True, to=orm['main.Question'], blank=True), keep_default=False)

        # Adding field 'Question.level'
        db.add_column('main_question', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(default='', db_index=True), keep_default=False)

        # Adding field 'Question.tree_id'
        db.add_column('main_question', 'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(default='', db_index=True), keep_default=False)

        # Adding field 'Question.rght'
        db.add_column('main_question', 'rght', self.gf('django.db.models.fields.PositiveIntegerField')(default='', db_index=True), keep_default=False)

        # Removing M2M table for field questions on 'Questionnaire'
        db.delete_table('main_questionnaire_questions')

        # Deleting field 'UIDQuestion.selected_choice'
        db.delete_column('main_uidquestion', 'selected_choice_id')
    ...
    models = {
        ...
        'main.questionnaire': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'questions': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['main.Question']", 'null': 'True', 'blank': 'True'}),
