...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UIDStatus.role'
        db.add_column('main_uidstatus', 'role', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='uids', to=orm['main.Role']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UIDStatus.role'
        db.delete_column('main_uidstatus', 'role_id')
    ...
    models = {
        ...
        'main.uidstatus': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Project']"}),
            'role': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'uids'", 'to': "orm['main.Role']"}),
