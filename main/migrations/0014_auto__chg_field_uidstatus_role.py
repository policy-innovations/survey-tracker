...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UIDStatus.role'
        db.alter_column('main_uidstatus', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.Role']))
    ...
    models = {
        ...
        'main.uidstatus': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Project']"}),
            'role': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'uids'", 'null': 'True', 'to': "orm['main.Role']"}),
