...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UIDStatus.extra_details'
        db.add_column('main_uidstatus', 'extra_details', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UIDStatus.extra_details'
        db.delete_column('main_uidstatus', 'extra_details')
