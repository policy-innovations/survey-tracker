...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UIDStatus.completer'
        db.add_column('main_uidstatus', 'completer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Role'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UIDStatus.completer'
        db.delete_column('main_uidstatus', 'completer_id')
